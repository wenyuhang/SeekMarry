package com.wl.seekmarry.model.glide;
...
public class OkHttpGlideModule implements GlideModule {
    ...
    public void registerComponents(Context context, Glide glide) {
        ...
        X509TrustManager xtm = new X509TrustManager() {            @Override
        ...
        HostnameVerifier DO_NOT_VERIFY = new HostnameVerifier() {            @Override
